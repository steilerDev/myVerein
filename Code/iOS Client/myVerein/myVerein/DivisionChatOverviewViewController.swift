...
class DivisionChatOverviewViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(reuseIdentifier, forIndexPath: indexPath) as! DivisionChatCell
        
        // Configure the cell
        
        cell.divisionLabel.text = user[indexPath.row]
        cell.lastUser = user[indexPath.row]

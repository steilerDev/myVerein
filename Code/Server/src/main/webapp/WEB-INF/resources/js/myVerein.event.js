...
function loadEventPage() {
    ...
    if(!map)
    {
        ...
        } else
        {
            ...
            $('#map').addClass('hidden');
            showMessage("Unable to reach GoogleMaps API, disabling map.", 'error', 'icon_error-triangle_alt');
        }
    }
